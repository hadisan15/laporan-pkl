...
if (isset($_POST["submit"])) {
  if (tambahPendaftar($_POST) > 0) {
    echo "<script>alert('Data Pendaftar Berhasil Ditambah');document.location.href = 'pendaftar_show.php';</script>";
  } else {
    echo "<script>alert('Data Pendaftar Gagal Ditambah');document.location.href = 'pendaftar_show.php';</script>";
  }
}
...
<head>
  ...
  <title>Admin - Tambah Data Pendaftar</title>
...
<body>
  ...
  <section id="body">
    <div class="container">
      <h1 class="text-primary mb-5 text-center fw-bold">Tambah Data Pendaftar <br> Pelatihan Digital Marketing</h1>
      <div class="row mb-3">
        <div class="col-md-9">
        ...
        <div class="col">
          <form method="post">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="kode_partisipan" name="kode_partisipan" autocomplete="off" autofocus value="" required>
            </div>
            <div class="mb-3">
              <label for="nama_pendaftar" class="form-label">Nama Pendaftar</label>
              <input type="text" class="form-control" id="nama_pendaftar" name="nama_pendaftar" autocomplete="off" value="" required>
            </div>
            <div class="mb-3">
              <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
              <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" autocomplete="off" value="" required>
            </div>
            <div class="mb-3">
              <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
              <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" autocomplete="off" value="">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="alamat_lengkap" name="alamat_lengkap" autocomplete="off" value="" required>
            </div>
            <div class="mb-3">
              <label for="bidang_usaha" class="form-label">Bidang Usaha</label>
              <input type="text" class="form-control" id="bidang_usaha" name="bidang_usaha" autocomplete="off" value="" required>
            </div>
            <div class="mb-3">
              <label for="email" class="form-label">Email</label>
              <input type="email" class="form-control" id="email" name="email" autocomplete="off" value="" required>
            </div>
            <div class="mb-3">
              <label for="no_telp" class="form-label">No Telepon</label>
              <input type="number" class="form-control" id="no_telp" name="no_telp" autocomplete="off" value="" required>
            </div>
            <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data Pendaftar</button>
