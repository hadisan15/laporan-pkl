...
<html lang="en">
  <head>
    ...
    <title>Admin - Tabel Data Pendaftar</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-7">
            <a href="pendaftar_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pendaftar</button>
            </a>
            <a href="pendaftar_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pendaftar</button>
            </a>
          </div>
          <div class="col-md-5">
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><?= $row["no_telp"]; ?></td>
                <td>
                  <a href="pendaftar_update.php?id_pendaftar=<?= $row["id_pendaftar"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i></span>
                  </a><br>
                  <a href="pendaftar_remove.php?id_pendaftar=<?= $row["id_pendaftar"]; ?>" >
