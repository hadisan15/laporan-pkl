...
if(isset($_POST["submit"])) {
  if(hapusPendaftar($id_pendaftar)>0) {
    echo"<script>alert('Data Pendaftar Berhasil Dihapus');document.location.href = 'pendaftar_show.php';</script>";
  } else {
    echo"<script>alert('Data Pendaftar Gagal Dihapus');document.location.href = 'pendaftar_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Hapus Data Pendaftar</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Hapus Data Pendaftar <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Pendaftar</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kode Partisipan
                      <div class="fw-bold"><?= $tb_pendaftar["kode_partisipan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Pendaftar
                      <div class="fw-bold"><?= $tb_pendaftar["nama_pendaftar"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat Lahir
                      <div class="fw-bold"><?= $tb_pendaftar["tempat_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Lahir
                      <div class="fw-bold"><?= $tb_pendaftar["tanggal_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jenis Kelamin
                      <div class="fw-bold"><?= $tb_pendaftar["jenis_kelamin"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Alamat Lengkap
                      <div class="fw-bold"><?= $tb_pendaftar["alamat_lengkap"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Bidang Usaha
                      <div class="fw-bold"><?= $tb_pendaftar["bidang_usaha"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Email
                      <div class="fw-bold"><?= $tb_pendaftar["email"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      No Telepon
                      <div class="fw-bold"><?= $tb_pendaftar["no_telp"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data Pendaftar</button>
            </form>
          </div>
        </div>
      </div>
