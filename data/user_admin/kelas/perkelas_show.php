...
<html lang="en">
  <head>
    ...
    <title>Admin - Tabel Data Kelas <?= $_GET["nama_kelas"]; ?></title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tabel Data Kelas <?= $_GET["nama_kelas"]; ?> <br> Pelatihan Digital Marketing</h1>
        <div class="row">
          <div class="col-md-7 mb-3">
            <a href="kelas_show.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-table"></i> Tabel Data Kelas</button>
            </a>
            <a href="perkelas_print.php?nama_kelas=<?= $_GET["nama_kelas"]; ?>">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Kelas <?= $_GET["nama_kelas"]; ?></button>
            </a>
          </div>
