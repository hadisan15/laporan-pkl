...
<html lang="en">
  <head>
    ...
    <title>Admin - Tambah Data Kelas</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tambah Data Kelas <br> Pelatihan Digital Marketing</h1>
          ...
          <div class="col">
            <form method="post">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama_kelas" name="nama_kelas" required autocomplete="off" value="" autofocus>
              </div>
              <div class="mb-3">
                <label for="nama_pengajar" class="form-label">Nama Pengajar</label>
                <select class="form-select" name="nama_pengajar" id="nama_pengajar">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="jumlah_peserta" name="jumlah_peserta" required autocomplete="off" value="">
              </div>
              <div class="mb-3">
                <label for="tanggal_mulai" class="form-label">Tanggal Mulai</label>
                <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" required autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="tanggal_selesai" class="form-label">Tanggal Selesai</label>
                <input type="date" class="form-control" id="tanggal_selesai" name="tanggal_selesai" required autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="waktu_pelaksanaan" class="form-label">Waktu Pelaksanaan</label>
                <input type="time" class="form-control" id="waktu_pelaksanaan" name="waktu_pelaksanaan" required autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="tempat_pelaksanaan" class="form-label">Tempat Pelaksanaan</label>
                <input type="text" class="form-control" id="tempat_pelaksanaan" name="tempat_pelaksanaan" required autocomplete="off" value="">
              </div>
