...
<html lang="en">
  <head>
    ...
    <title>Admin - Hapus Data Kelas</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Hapus Data Kelas <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <!-- <a href="../../index.php">
                ...
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Kelas
                      <div class="fw-bold"><?= $tb_kelas["nama_kelas"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Pengajar
                      <div class="fw-bold"><?= $tb_kelas["nama_pengajar"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jumlah Peserta
                      <div class="fw-bold"><?= $tb_kelas["jumlah_peserta"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Mulai
                      <div class="fw-bold"><?= $tb_kelas["tanggal_mulai"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Selesai
                      <div class="fw-bold"><?= $tb_kelas["tanggal_selesai"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Waktu Pelaksanaan
                      <div class="fw-bold"><?= $tb_kelas["waktu_pelaksanaan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat Pelaksanaan
                      <div class="fw-bold"><?= $tb_kelas["tempat_pelaksanaan"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
