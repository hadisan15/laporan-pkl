...
if(isset($_POST["submit"])) {
  if(hapusPeserta($id_peserta)>0) {
    echo"<script>alert('Data Peserta Berhasil Dihapus');document.location.href = 'peserta_show.php';</script>";
  } else {
    echo"<script>alert('Data Peserta Gagal Dihapus');document.location.href = 'peserta_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Hapus Data Peserta</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Hapus Data Peserta <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Peserta</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kode Partisipan
                      <div class="fw-bold"><?= $tb_peserta["kode_partisipan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Peserta
                      <div class="fw-bold"><?= $tb_peserta["nama_pendaftar"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Kelas
                      <div class="fw-bold"><?= $tb_peserta["nama_kelas"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          ...
          <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data Peserta</button>
            </form>
          </div>
        </div>
      </div>
