...
if(isset($_POST["submit"])) {
  if(ubahAlumni($_POST)>0) {
    echo "<script>alert('Data Alumni Berhasil Diubah');document.location.href = 'alumni_show.php';</script>";
  } else {
    echo "<script>alert('Data Alumni Gagal Diubah');document.location.href = 'alumni_show.php';</script>";
  }
}
...
<html lang="en">
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Ubah Data Alumni <br> Pelatihan Digital Marketing</h1>
        ...
        <div class="row">
          <div class="col">
            <form method="post">
              <p class="fw-bold"><?= $tb_alumni["nama_pendaftar"] ?></p>
              <input type="hidden" name="id" value="<?= $tb_alumni["id_alumni"]; ?>">
              <div class="mb-3">
                ...
                <select class="form-select" name="kode_partisipan" id="kode_partisipan">
                  <option selected><?= $tb_alumni["kode_partisipan"] ?></option>
                  <?php 
              ...
              <button type="submit" name="submit" class="btn btn-success"><i class="bi bi-check-circle-fill"></i> Ubah Data Alumni</button>
