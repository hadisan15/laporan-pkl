...
$tb_alumni = queryTampilAlumni("SELECT * FROM tbjoin_pesertakelasalumni WHERE id_alumni = $id_alumni")[0];

if(isset($_POST["submit"])) {
  if(hapusAlumni($id_alumni)>0) {
    echo "<script>alert('Data Alumni Berhasil Dihapus');document.location.href = 'alumni_show.php';</script>";
  } else {
    echo "<script>alert('Data Alumni Gagal Dihapus');document.location.href = 'alumni_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Hapus Data Alumni</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Hapus Data Alumni <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
            <!-- <a href="../../index.php">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Alumni</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kode Partisipan
                      <div class="fw-bold"><?= $tb_alumni["kode_partisipan"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Alumni
                      <div class="fw-bold"><?= $tb_alumni["nama_pendaftar"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Selesai
                      <div class="fw-bold"><?= $tb_alumni["tanggal_selesai"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data Alumni</button>
            </form>
          </div>
        </div>
      </div>
