...
if ( isset($_POST["cariAlumni"]) ) {
	$alumni = cariAlumni($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Tabel Data Alumni</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tabel Data Alumni <br> Pelatihan Digital Marketing</h1>
        <div class="row">
          <div class="col-md-7">
            <!-- <a href="../../index.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-house-door-fill"></i> Kembali ke Beranda</button>
            </a> -->
            <a href="alumni_input.php">
              <button type="button" class="btn btn-outline-primary" id="admin-only"><i class="bi bi-person-plus-fill"></i> Tambah Data Alumni</button>
            </a>
            <a href="alumni_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Alumni</button>
            </a>
          </div>
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama Alumni" name="keyword" size="70" autofocus autocomplete="off">
                <button class="btn btn-outline-primary ms-1" type="submit" name="cariAlumni"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <a href="alumni_update.php?id_alumni=<?= $row["id_alumni"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i></span>
                  </a><br>
                  <a href="alumni_remove.php?id_alumni=<?= $row["id_alumni"]; ?>" >
