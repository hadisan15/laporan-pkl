...
<html lang="en">
  <head>
    ...
    <title>Admin - Tabel Data Pengguna</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tabel Data Pengguna Website <br> Sistem Informasi Manajemen Data <br> Pelatihan Digital Marketing</h1>
        <div class="row">
          <div class="col-md-7">
            <a href="pengguna_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pengguna</button>
            </a>
            <a href="pengguna_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pengguna</button>
            </a>
          </div>
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama Pengguna" name="keyword" size="70" autofocus autocomplete="off">
                <button class="btn btn-outline-primary ms-1" type="submit" name="cariPengguna"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><?= $row["level"]; ?></td>
                <td>
                  <a href="pengguna_update.php?id_pengguna=<?= $row["id_pengguna"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i></span>
                  </a><br>
                  <a href="pengguna_remove.php?id_pengguna=<?= $row["id_pengguna"]; ?>" >
