...
if(isset($_POST["submit"])) {
  if(hapusPengguna($id_pengguna)>0) {
    echo "<script>alert('Data Pengguna Berhasil Dihapus');document.location.href = 'pengguna_show.php';</script>";
  } else {
    echo "<script>alert('Data Pengguna Gagal Dihapus');document.location.href = 'pengguna_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Hapus Data Pengguna</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Hapus Data Pengguna <br> Website SIM Data <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <div class="card">
              <div class="card-header fw-bolder">
                <h5 class="card-title">Konfirmasi Penghapusan Data Pengguna</h5>
              </div>
              <div class="card-body">
                <ol class="list-group mb-3">
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Kode Pengguna
                      <div class="fw-bold"><?= $tb_pengguna_bio["kode_pengguna"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Nama Pengguna
                      <div class="fw-bold"><?= $tb_pengguna_bio["nama_lengkap"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      E-mail
                      <div class="fw-bold"><?= $tb_pengguna_bio["email"] ?></div>
                    </div>
                  </li>
                  <!-- <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Password
                      <div class="fw-bold"><?= $tb_pengguna_bio["password"] ?></div>
                    </div>
                  </li> -->
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tempat Lahir
                      <div class="fw-bold"><?= $tb_pengguna_bio["tempat_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Tanggal Lahir
                      <div class="fw-bold"><?= $tb_pengguna_bio["tanggal_lahir"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Jenis Kelamin
                      <div class="fw-bold"><?= $tb_pengguna_bio["jenis_kelamin"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Alamat
                      <div class="fw-bold"><?= $tb_pengguna_bio["alamat"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      No Telepon
                      <div class="fw-bold"><?= $tb_pengguna_bio["no_telp"] ?></div>
                    </div>
                  </li>
                  <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                      Level Pengguna
                      <div class="fw-bold"><?= $tb_pengguna_bio["level"] ?></div>
                    </div>
                  </li>
                </ol>
                <p class="text-danger">
        ...
        <div class="row">
          <div class="col">
            <form action="" method="post">
              <button type="submit" name="submit" class="btn btn-danger"><i class="bi bi-x-circle-fill"></i> Hapus Data Pengguna</button>
            </form>
          </div>
        </div>
      </div>
