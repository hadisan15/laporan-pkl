...
if(isset($_POST["submit"])) {
  if(tambahPengguna($_POST) > 0) {
    echo "<script>alert('Data Pengguna Berhasil Ditambah!');document.location.href = 'pengguna_show.php'</script>";
  } else {
    echo "<script>alert('Data Pengguna Gagal Ditambah');document.location.href = 'pengguna_show.php';</script>";
  }
}
?>
...
<html lang="en">
  <head>
    ...
    <title>Admin - Tambah Data Pengguna</title>
      ...
      <div class="container">
        <div class="row mb-3 justify-content-center">
          <div class="col-md-8">
            <div class="card mb-3">
              <div class="card-body">
              <h1 class="text-primary mb-5 text-center fw-bold">Tambah Data Pengguna <br> Website SIM Data <br> Pelatihan Digital Marketing</h1>
                <form method="post">
                  ...
                  <div class="row mb-2 mt-5">
                    <div class="col text-center">
                      <button type="submit" class="btn btn-primary" name="submit"><i class="bi bi-plus-circle-fill"></i> Tambah Data Pengguna</button>
