...
if(isset($_POST["submit"])) {
  if(tambahPengajar($_POST)>0) {
    echo "<script>alert('Data Pengajar Berhasil Ditambah');document.location.href = 'pengajar_show.php';</script>";
  } else {
    echo "<script>alert('Data Pengajar Gagal Ditambah');document.location.href = 'pengajar_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Tambah Data Pengajar</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tambah Data Pengajar <br> Pelatihan Digital Marketing</h1>
        <div class="row mb-3">
          <div class="col-md-9">
          ...
          <div class="col">
            <form method="post">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="kode_pengajar" name="kode_pengajar" required autocomplete="off" value="" autofocus>
              </div>
              <div class="mb-3">
                <label for="nama_pengajar" class="form-label">Nama Pengajar</label>
                <input type="text" class="form-control" id="nama_pengajar" name="nama_pengajar" required autocomplete="off" value="">
              </div>
              <div class="mb-3">
                <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" required autocomplete="off" value="">
              </div>
              <div class="mb-3">
                <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                <input type="date" class="form-control" id="tanggal_lahir" name="tanggal_lahir" required autocomplete="off" value="">
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="number" class="form-control" id="no_telp" name="no_telp" required autocomplete="off" value="">
              </div>
              <button type="submit" name="submit" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Data Pengajar</button>
