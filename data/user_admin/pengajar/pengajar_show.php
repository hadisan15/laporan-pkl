...
if ( isset($_POST["cariPengajar"]) ) {
	$pengajar = cariPengajar($_POST["keyword"]);
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Tabel Data Pengajar</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Tabel Data Pengajar <br> Pelatihan Digital Marketing</h1>
        <div class="row">
          <div class="col-md-7">
            <a href="pengajar_input.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-person-plus-fill"></i> Tambah Data Pengajar</button>
            </a>
            <a href="pengajar_print.php">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-printer-fill"></i> Cetak Data Pengajar</button>
            </a>
          </div>
          <div class="col-md-5">
            <div class="input-group mb-3">
              <form action="" method="post" class="d-flex">         
                <input type="text" class="form-control" placeholder="Cari Nama Pengajar" name="keyword" size="70" autofocus autocomplete="off">
                <button class="btn btn-outline-primary ms-1" type="submit" name="cariPengajar"><i class="bi bi-search"></i></button>
              </form>
            </div>
          </div>
        </div>
          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><?= $row["no_telp"]; ?></td>
                <td>
                  <a href="pengajar_update.php?id_pengajar=<?= $row["id_pengajar"]; ?>">
                    <span class="badge bg-success"><i class="bi bi-pen-fill"></i></span>
                  </a><br>
                  <a href="pengajar_remove.php?id_pengajar=<?= $row["id_pengajar"]; ?>" >
