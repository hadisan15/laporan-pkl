...
if(isset($_POST["submit"])) {
  if(ubahPengajar($_POST)>0) {
    echo "<script>alert('Data Pengajar Berhasil Diubah');document.location.href = 'pengajar_show.php';</script>";
  } else {
    echo "<script>alert('Data Pengajar Gagal Diubah');document.location.href = 'pengajar_show.php';</script>";
  }
}
...
<html lang="en">
  <head>
    ...
    <title>Admin - Ubah Data Pengajar</title>
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Ubah Data Pengajar <br> Pelatihan Digital Marketing</h1>
        ...
        <div class="row">
          <div class="col">
            <form method="post">
              <p class="fw-bold"><?= $tb_pengajar["nama_pengajar"] ?></p>
              <input type="hidden" name="id" value="<?= $tb_pengajar["id_pengajar"]; ?>">
              <div class="mb-3">
                <label for="kode_pengajar" class="form-label">Kode Pengajar</label>
                <input type="text" class="form-control" id="kode_pengajar" name="kode_pengajar" value="<?= $tb_pengajar["kode_pengajar"] ?>" required autocomplete="off" disabled>
              </div>
              <div class="mb-3">
                <label for="nama_pengajar" class="form-label">Nama Pengajar</label>
                <input type="text" class="form-control" id="nama_pengajar" name="nama_pengajar" value="<?= $tb_pengajar["nama_pengajar"] ?>" required  autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="tempat_lahir" class="form-label">Tempat Lahir</label>
                <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?= $tb_pengajar["tempat_lahir"] ?>" required  autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="tanggal_lahir" class="form-label">Tanggal Lahir</label>
                <input type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= $tb_pengajar["tanggal_lahir"] ?>" required  autocomplete="off">
              </div>
              <div class="mb-3">
                <label for="jenis_kelamin" class="form-label">Jenis Kelamin</label>
                <select class="form-select" name="jenis_kelamin" id="jenis_kelamin">
                  <option selected><?= $tb_pengajar["jenis_kelamin"] ?></option>
                  <?php 
              ...
              <div class="mb-3">
                ...
                <input type="email" class="form-control" id="email" name="email" value="<?= $tb_pengajar["email"] ?>" required>
              </div>
              <div class="mb-3">
                <label for="no_telp" class="form-label">No Telepon</label>
                <input type="number" class="form-control" id="no_telp" name="no_telp" value="<?= $tb_pengajar["no_telp"] ?>" required>
              </div>
