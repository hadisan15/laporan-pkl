...
<html lang="en">
  <head>
    ...
    <title>Pimpinan - Cetak Data Kelas</title>
          ...
          <div class="btn-group ms-5 mt-2" role="group" aria-label="Button group with nested dropdown">
            ...
            <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                ...
                <li>
                  <a class="dropdown-item text-primary" href="pengguna_print"><i class="bi bi-people-fill"></i> Laporan Data Pengguna</a>
                </li>
              </ul>
            </div>
      ...
      <div class="container">
        <div class="row mb-3">
          ...
          <div class="col-md-9 justify-content-center text-center head-print">
            <h2 style="font-family: 'Times New Roman'; font-weight: bold; color: rgb(12, 54, 117);">LAPORAN DATA KELAS <br> PELATIHAN DIGITAL MARKETING <br> PT. RAJAWALI CIPTA HARAPAN</h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
            <table class="table table-bordered border-dark" style="font-family: 'Times New Roman';">
              ...
              <tr>
                ...
                <td>
                  <a href="perkelas_print.php?nama_kelas=<?= $row["nama_kelas"]; ?>" >
