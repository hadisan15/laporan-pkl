...
<html lang="en">
  ...
  <body>
    ...
    <section id="body">
      <div class="container">
        <h1 class="text-primary mb-5 text-center fw-bold">Cetak Data Pengajar <br> Pelatihan Digital Marketing</h1>
        <div class="row">
          <div class="col">
            <a href="pengajar_savepdf.php" target="_blank">
              <button type="button" class="btn btn-outline-primary"><i class="bi bi-save-fill"></i> Unduh Data Pengajar</button>
            </a>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row mb-3">
          ...
          <div class="col-md-9 justify-content-center text-center head-print">
            <h2 style="font-family: 'Times New Roman'; font-weight: bold; color: rgb(12, 54, 117);">LAPORAN DATA PENGAJAR <br> PELATIHAN DIGITAL MARKETING <br> PT. RAJAWALI CIPTA HARAPAN</h2>
          </div>
        </div>
        <div class="row">
          <div class="col">
