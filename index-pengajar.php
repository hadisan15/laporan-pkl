          ...
          <div class="btn-group ms-5 mt-2" role="group" aria-label="Button group with nested dropdown">
            ...
            <div class="btn-group" role="group">
              ...
              <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                <li>
                  <a class="dropdown-item text-primary" href="data/user_pengajar/pendaftar_show.php"><i class="bi bi-person-fill"></i> Data Pendaftar</a>
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="data/user_pengajar/peserta_show.php"><i class="bi bi-person-circle"></i> Data Peserta</a>
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="data/user_pengajar/alumni_show.php"><i class="bi bi-person-check-fill"></i> Data Alumni</a>
                </li>
                <!-- <li>
                  <a class="dropdown-item text-primary" href="data/user_pengajar/pengajar_show.php"><i class="bi bi-mortarboard-fill"></i> Data Pengajar</a>
                </li>
                <li>
                  <a class="dropdown-item text-primary" href="data/user_pengajar/kelas_show.php"><i class="bi bi-folder-fill"></i> Data Kelas</a>
                </li> -->
              </ul>
            </div>
            <a class="btn-group" href="data/user_pengajar/profile_pengajar.php">
